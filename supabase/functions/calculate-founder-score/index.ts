...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.error("calculate-founder-score error:", err);
    return new Response(JSON.stringify({ error: "Failed to calculate score. Please try again." }), { status: 500, headers: corsHeaders });
  }
});
